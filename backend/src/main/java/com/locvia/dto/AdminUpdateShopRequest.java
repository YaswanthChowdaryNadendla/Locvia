...
/**
 * Payload submitted by an administrator to update shop information,
 * active status, and store details.
 */
public class AdminUpdateShopRequest {
    ...
    public AdminUpdateShopRequest(String name, String description, String address, String phone, String email, String imageUrl, Double latitude, Double longitude, Double rating, Boolean active) {
        this.name = name;
